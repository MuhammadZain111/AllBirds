      ...
      <div class="w-full bg-stone-100 rounded-full px-4 py-3 flex items-center justify-between cursor-pointer  ">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center border border-gray-400 rounded-full p-1">
            <button class="px-6 py-2 rounded-full bg-gray-900 text-white text-sm font-semibold cursor-pointer   ">
              MEN
            </button>

            <button class="px-6 py-2 rounded-full cursor-pointer text-gray-700 text-sm font-semibold">
              WOMEN
            </button>
          </div>
          ...
          <button class="flex items-center gap-3 border border-gray-400 rounded-full px-6 py-3 text-sm font-semibold text-gray-800 cusrsor-pointer  ">
            FEATURED
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-4 h-4"
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 text-black curosor-pointer  ">
                {["Black", "Grey", "White", "Red", "Green", "Blue"].map((c) => (
                  <label
                    key={c}
                    className="flex items-center gap-2 text-sm curosor-pointer "
                  >
                    <input type="checkbox" />
                    {c}
                  </label>
            ...
            <div>
              ...
              {["Under $75", "$75-$100", "$100-$150", "Over $150"].map((p) => (
                <label
                  key={p}
                  className="flex cursor-pointer  gap-2 mb-2 text-sm text-black"
                >
                  <input type="checkbox" />
                  {p}
                </label>
            ...
            <div>
              ...
              {["Sneakers", "Sandals", "Slip Ons", "Running"].map((t) => (
                <label
                  key={t}
                  className="flex gap-2 mb-2 text-sm cursor-pointer text-black "
                >
                  <input type="checkbox" />
                  {t}
                </label>
            ...
            <div>
              ...
              {["Canvas", "Cotton", "Wool"].map((m) => (
                <label
                  key={m}
                  className="flex gap-2 mb-2 text-sm text-black cursor-pointer"
                >
                  <input type="checkbox" />
                  {m}
                </label>
