...
function Header() {
  ...
  return ( 
  <div className={` bg-[url('/images/collection_header.webp')] h-[30vh] w-[99%] pt-1 pb-2 font-serif text-white rounded-md md:mb-3 flex flex-col items-center justify-center mt-3  `}
    >
